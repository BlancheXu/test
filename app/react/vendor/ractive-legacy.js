(function (global, factory) {
  ...
  var Registry = (function () {
  	function Registry(name, useDefaults) {
  		_classCallCheck$11(this, Registry);
  ...
  var ArrayWrapper = (function () {
  	function ArrayWrapper(ractive, array) {
  		_classCallCheck$3(this, ArrayWrapper);
  ...
  var MagicWrapper = (function () {
  	function MagicWrapper(ractive, value, keypath) {
  		...
  		_classCallCheck$4(this, MagicWrapper);
  ...
  var MagicArrayWrapper = (function () {
  	function MagicArrayWrapper(ractive, array, keypath) {
  		_classCallCheck$5(this, MagicArrayWrapper);
  ...
  var Ticker = (function () {
  	function Ticker(options) {
  		_classCallCheck$19(this, Ticker);
  ...
  var KeyModel = (function () {
  	function KeyModel(key) {
  		_classCallCheck$20(this, KeyModel);
  ...
  var KeypathModel = (function () {
  	function KeypathModel(parent, ractive) {
  		_classCallCheck$21(this, KeypathModel);
  ...
  var ComputationChild = (function (_Model) {
  	_inherits$4(ComputationChild, _Model);

  	function ComputationChild() {
  		_classCallCheck$18(this, ComputationChild);
  ...
  var Computation = (function (_Model) {
  	_inherits$1(Computation, _Model);

  	function Computation(viewmodel, signature, key) {
  		_classCallCheck$12(this, Computation);
  ...
  var RactiveModel = (function (_Model) {
  	_inherits$2(RactiveModel, _Model);

  	function RactiveModel(ractive) {
  		_classCallCheck$14(this, RactiveModel);
  ...
  var GlobalModel = (function (_Model) {
  	_inherits$3(GlobalModel, _Model);

  	function GlobalModel() {
  		_classCallCheck$15(this, GlobalModel);
  ...
  var RootModel = (function (_Model) {
  	_inherits(RootModel, _Model);

  	function RootModel(options) {
  		_classCallCheck$6(this, RootModel);
  ...
  var HookQueue = (function () {
  	function HookQueue(event) {
  		_classCallCheck$9(this, HookQueue);
  ...
  var ExpressionProxy = (function (_Model) {
  	_inherits$23(ExpressionProxy, _Model);

  	function ExpressionProxy(fragment, template) {
  		var _this = this;

  		_classCallCheck$47(this, ExpressionProxy);
  ...
  var ReferenceExpressionProxy = (function (_Model) {
  	_inherits$24(ReferenceExpressionProxy, _Model);

  	function ReferenceExpressionProxy(fragment, template) {
  		var _this = this;

  		_classCallCheck$48(this, ReferenceExpressionProxy);
  ...
  var Alias = (function (_Item) {
  	_inherits$5(Alias, _Item);

  	function Alias(options) {
  		_classCallCheck$22(this, Alias);
  ...
  var Doctype = (function (_Item) {
  	_inherits$7(Doctype, _Item);

  	function Doctype() {
  		_classCallCheck$24(this, Doctype);
  ...
  var Mustache = (function (_Item) {
  	_inherits$22(Mustache, _Item);

  	function Mustache(options) {
  		_classCallCheck$45(this, Mustache);
  ...
  var Interpolator = (function (_Mustache) {
  	_inherits$10(Interpolator, _Mustache);
  ...
  var Partial = (function (_Mustache) {
  	_inherits$13(Partial, _Mustache);

  	function Partial() {
  		_classCallCheck$30(this, Partial);
  ...
  var RepeatedFragment = (function () {
  	function RepeatedFragment(options) {
  		_classCallCheck$46(this, RepeatedFragment);
  ...
  var Section = (function (_Mustache) {
  	_inherits$14(Section, _Mustache);

  	function Section(options) {
  		_classCallCheck$31(this, Section);
  ...
  var Triple = (function (_Mustache) {
  	_inherits$18(Triple, _Mustache);

  	function Triple(options) {
  		_classCallCheck$35(this, Triple);
  ...
  var Yielder = (function (_Item) {
  	_inherits$19(Yielder, _Item);

  	function Yielder(options) {
  		_classCallCheck$36(this, Yielder);
  ...
  var Attribute = (function (_Item) {
  	_inherits$20(Attribute, _Item);

  	function Attribute(options) {
  		_classCallCheck$40(this, Attribute);
  ...
  var ConditionalAttribute = (function (_Item) {
  	_inherits$21(ConditionalAttribute, _Item);

  	function ConditionalAttribute(options) {
  		_classCallCheck$41(this, ConditionalAttribute);
  ...
  var Decorator = (function () {
  	function Decorator(owner, template) {
  		_classCallCheck$42(this, Decorator);
  ...
  var EventDirective = (function () {
  	function EventDirective(owner, event, template) {
  		_classCallCheck$38(this, EventDirective);
  ...
  var DOMEvent = (function () {
  	function DOMEvent(name, owner) {
  		_classCallCheck$43(this, DOMEvent);
  ...
  var CustomEvent = (function () {
  	function CustomEvent(eventPlugin, owner) {
  		_classCallCheck$43(this, CustomEvent);
  ...
  var Transition = (function () {
  	function Transition(owner, template, isIntro) {
  		_classCallCheck$44(this, Transition);
  ...
  var Binding = (function () {
  	function Binding(element) {
  		...
  		_classCallCheck$49(this, Binding);
  ...
  var CheckboxBinding = (function (_Binding) {
  	_inherits$25(CheckboxBinding, _Binding);

  	function CheckboxBinding(element) {
  		_classCallCheck$50(this, CheckboxBinding);
  ...
  var BindingGroup = (function () {
  	function BindingGroup(hash, model, getValue) {
  		...
  		_classCallCheck$59(this, BindingGroup);
  ...
  var CheckboxNameBinding = (function (_Binding) {
  	_inherits$26(CheckboxNameBinding, _Binding);

  	function CheckboxNameBinding(element) {
  		_classCallCheck$51(this, CheckboxNameBinding);
  ...
  var ContentEditableBinding = (function (_Binding) {
  	_inherits$27(ContentEditableBinding, _Binding);

  	function ContentEditableBinding() {
  		_classCallCheck$52(this, ContentEditableBinding);
  ...
  var GenericBinding = (function (_Binding) {
  	_inherits$28(GenericBinding, _Binding);

  	function GenericBinding() {
  		_classCallCheck$53(this, GenericBinding);
  ...
  var MultipleSelectBinding = (function (_Binding) {
  	_inherits$29(MultipleSelectBinding, _Binding);

  	function MultipleSelectBinding() {
  		_classCallCheck$54(this, MultipleSelectBinding);
  ...
  var NumericBinding = (function (_GenericBinding) {
  	_inherits$30(NumericBinding, _GenericBinding);

  	function NumericBinding() {
  		_classCallCheck$55(this, NumericBinding);
  ...
  var RadioBinding = (function (_Binding) {
  	_inherits$31(RadioBinding, _Binding);

  	function RadioBinding(element) {
  		_classCallCheck$56(this, RadioBinding);
  ...
  var RadioNameBinding = (function (_Binding) {
  	_inherits$32(RadioNameBinding, _Binding);

  	function RadioNameBinding(element) {
  		_classCallCheck$57(this, RadioNameBinding);
  ...
  var SingleSelectBinding = (function (_Binding) {
  	_inherits$33(SingleSelectBinding, _Binding);

  	function SingleSelectBinding() {
  		_classCallCheck$58(this, SingleSelectBinding);
  ...
  var Element = (function (_Item) {
  	_inherits$9(Element, _Item);

  	function Element(options) {
  		var _this = this;

  		_classCallCheck$26(this, Element);
  ...
  var Input = (function (_Element) {
  	_inherits$11(Input, _Element);

  	function Input() {
  		_classCallCheck$28(this, Input);
  ...
  var Textarea = (function (_Input) {
  	_inherits$16(Textarea, _Input);

  	function Textarea(options) {
  		_classCallCheck$33(this, Textarea);
  ...
  var Select = (function (_Element) {
  	_inherits$15(Select, _Element);

  	function Select(options) {
  		_classCallCheck$32(this, Select);
  ...
  var Option = (function (_Element) {
  	_inherits$12(Option, _Element);

  	function Option(options) {
  		_classCallCheck$29(this, Option);
  ...
  var Form = (function (_Element) {
  	_inherits$8(Form, _Element);

  	function Form(options) {
  		_classCallCheck$25(this, Form);
  ...
  var RactiveEvent = (function () {
  	function RactiveEvent(ractive, name) {
  		_classCallCheck$39(this, RactiveEvent);
  ...
  var Component = (function (_Item) {
  	_inherits$6(Component, _Item);

  	function Component(options, ComponentConstructor) {
  		_classCallCheck$23(this, Component);
  ...
  var Text = (function (_Item) {
  	_inherits$17(Text, _Item);

  	function Text(options) {
  		_classCallCheck$34(this, Text);
  ...
  var ReferenceResolver = (function () {
  	function ReferenceResolver(fragment, reference, callback) {
  		_classCallCheck$16(this, ReferenceResolver);
  ...
  var Fragment = (function () {
  	function Fragment(options) {
  		_classCallCheck$8(this, Fragment);
  ...
  function extendOne(Parent) {
  	...
  	if (options.prototype instanceof Ractive$1) {
  ...
  var ListObserver = (function () {
  	function ListObserver(context, model, callback, options) {
  		_classCallCheck$2(this, ListObserver);
  ...
  var PatternObserver = (function () {
  	function PatternObserver(ractive, baseModel, keys, callback, options) {
  		...
  		_classCallCheck$1(this, PatternObserver);
  ...
  if (typeof Date.now !== FUNCTION$1 || typeof String.prototype.trim !== FUNCTION$1 || typeof Object.keys !== FUNCTION$1 || typeof Array.prototype.indexOf !== FUNCTION$1 || typeof Array.prototype.forEach !== FUNCTION$1 || typeof Array.prototype.map !== FUNCTION$1 || typeof Array.prototype.filter !== FUNCTION$1 || win && typeof win.addEventListener !== FUNCTION$1) {
  	throw new Error('It looks like you\'re attempting to use Ractive.js in an older browser. You\'ll need to use one of the \'legacy builds\' in order to continue - see http://docs.ractivejs.org/latest/legacy-builds for more information.');
  }
  function Ractive$1(options) {
  	if (!(this instanceof Ractive$1)) return new Ractive$1(options);

  	construct(this, options || {});
  	initialise(this, options || {}, {});
  }

  extend(Ractive$1.prototype, proto$1, defaults);
  Ractive$1.prototype.constructor = Ractive$1;

  // alias prototype as `defaults`
  Ractive$1.defaults = Ractive$1.prototype;

  // static properties
  defineProperties(Ractive$1, {
  ...
  var TransitionManager = (function () {
  	function TransitionManager(callback, parent) {
  		_classCallCheck$17(this, TransitionManager);
